...
public class EditContractors {
    ...
    @FXML
    private Button editontractorsButton;
    ...
    public void initialize() {
        ...
        nameTextField.setText(customer.getOrganizationName());
        unnTextField.setText(customer.getInn().toString());
        kppTextField.setText(customer.getKpp().toString());
        correspondentTextField.setText(customer.getCorrespondentAccount().toString());
        estimatedTextField.setText(customer.getCheckingAccount().toString());
        okpoComboBox.setValue(customer.getOkpo().getId().toString());
        adressComboBox.setValue(customer.getLegalAddress().getId());
    ...
    @FXML
    void onEditContractorsButtonClick(ActionEvent event) {
